...
#ifndef RDSP_VOICESPOT_VOICESEEKER_DEVICE_CONFIG_H_
#define RDSP_VOICESPOT_VOICESEEKER_DEVICE_CONFIG_H_
...
typedef enum
{
    ...
    Device_IMXRT700_HIFI4,                          // I.MXRT700    : Running on HiFi4 DSP
    ...
    Device_IMX95_CM7,                               // I.MX95       : Running on Cortex-M7
    Device_IMX9_CA55,                               // I.MX9        : Running on Cortex-A55
    Device_DUMMY_DEVICE  = 99
} RDSP_DeviceId_en;

#endif // RDSP_VOICESPOT_VOICESEEKER_DEVICE_CONFIG_H_
